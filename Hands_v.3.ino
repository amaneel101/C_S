...
int buzzerPin = 10; //buzzer to arduino pin 10
...
void loop() {
 ...
 //THIS IS WHAT WE NEED TO WORK ON!!!!!!!
  tone(buzzerPin, r + 200); // Send 1KHz sound signal...
  delay(2000);        // ...for 1 sec
  tone(buzzerPin, g + 200); // Send 1KHz sound signal...
  delay(2000);
  tone(buzzerPin, b + 200); // Send 1KHz sound signal...
  delay(2000);
